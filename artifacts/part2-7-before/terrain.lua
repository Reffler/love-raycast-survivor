...
function Terrain:generate(cx,cy,output,surface)
  ...
  local fluids=region.hasFluid and region.fluid
  ...
  local maximum=0
  for i=0,255 do
    local h,code,water=self:finish(values[i],values[1024+i],values[256+i],values[512+i],values[768+i],values[1280+i],fluids and fluids[Fluid.key(x%1024+i%16,y%1024+math.floor(i/16))])
