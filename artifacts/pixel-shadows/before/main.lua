...
local dayPhase = 0.25 -- Start at noon; 0 sunrise, 0.5 sunset, 0.75 midnight.
...
function love.draw()
  ...
  sunDirection[1],sunDirection[3]=math.cos(angle),math.sin(angle)
  ...
  raycastShader:send('skyTint',skyTint);raycastShader:send('lightTint',lightTint)
