...
function love.load()
  ...
  for uniform,file in pairs({dirtTex="dirt",grassSideTex="grass_block_side",grassTopTex="grass_block_top"}) do
    local texture=love.graphics.newImage("textures/"..file..".png",{mipmaps=true})
    texture:setFilter("linear","nearest");texture:setMipmapFilter("linear");texture:setWrap("repeat","repeat")
